...
from ..models import jobs_model, job_skill_model, user_profile_model, user_profile_skill_model
...
def get_job_matching(db: Session, user_id: int) -> list[jobs_model.Job]:
    ...
    q_inner = db.query(user_profile_model.UserProfile, user_profile_skill_model.UserProfileSkill)\
    ...
    q_outer = db.query(jobs_model.Job.id, func.count(jobs_model.Job.id))\
        ...
        .join(q_inner, q_inner.c.skill_id == job_skill_model.JobSkill.skill_id)\
